  ...
  [:div {:class "container"}
   [:div {:class "box"}
    [:div {:class "content"}
     ...
     [:p "All members of the London Clojurians community are required to act and interact with other members following the code of conduct and the spirit of equality for all"]

     [:p "We are intolerant of intolerance and harassment in any form. If you experience or witness any harassment or behaviour that makes you feel uncomfortable in any way, please let us know in person at events or via the London Clojurian Organisers."]
     [:p "The quicker we know about an issue, the sooner we can consider how to resolve it and prevent further issues"]]]])
